...
export const INITIAL_OUTFITS: Outfit[] = [
    ...
    {
        id: 'OUT-007',
        name: 'Maharajah Heavy Brocade Sherwani',
        category: 'Sherwani',
        rentPrice: 9200,
        securityDeposit: 3500,
        status: 'available',
        imageUrl: 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=600&q=80',
        description: 'Maharajah style heavy gold zari brocade sherwani with velvet piping and handcrafted ruby brooch.',
        size: '42 (L)',
        chestSize: '42"',
        waistSize: '36"',
        fitType: 'Royal Tailored',
        color: 'Crimson Maroon & Zari',
        includedAccessories: ['Velvet Turban (Safa)', 'Embroidered Stole', 'Ruby Brooch', 'Royal Pearl Mala'],
    },
    {
        id: 'OUT-008',
        name: 'Layered Draped Silk Indo-Western Set',
        category: 'Indo-Western',
        rentPrice: 6800,
        securityDeposit: 2500,
        status: 'available',
        imageUrl: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=600&q=80',
        description: 'Contemporary layered draped silk jacket with asymmetrical metallic button closure and silk trousers.',
        size: '40 (M)',
        chestSize: '40"',
        waistSize: '34"',
        fitType: 'Slim Fit',
        color: 'Royal Wine & Gold',
        includedAccessories: ['Designer Brooch', 'Silk Dupatta'],
    },
    {
        id: 'OUT-009',
        name: 'Royal Velvet Jodhpuri Jacket Set',
        category: 'Jodhpuri',
        rentPrice: 7500,
        securityDeposit: 3000,
        status: 'available',
        imageUrl: 'https://images.unsplash.com/photo-1617922001439-4a2e6562f328?w=600&q=80',
        description: 'Deep emerald green plush velvet Jodhpuri jacket with antique brass crest buttons and tailored trousers.',
        size: '40 (M)',
        chestSize: '40"',
        waistSize: '34"',
        fitType: 'Regular Fit',
        color: 'Deep Emerald Green',
        includedAccessories: ['Antique Brass Crest Buttons', 'Silk Pocket Square'],
    },
    {
        id: 'OUT-010',
        name: 'Royal Velvet Dinner Blazer',
        category: 'Tuxedo & Suit',
        rentPrice: 4800,
        securityDeposit: 2000,
        status: 'available',
        imageUrl: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=600&q=80',
        description: 'Luxurious burgundy velvet dinner jacket featuring black satin shawl lapels and matching slim trousers.',
        size: '38 (S)',
        chestSize: '38"',
        waistSize: '32"',
        fitType: 'Slim Fit',
        color: 'Burgundy Velvet & Satin',
        includedAccessories: ['Velvet Bow Tie', 'Satin Pocket Square'],
    },
    {
        id: 'OUT-011',
        name: 'Handcrafted Silk Chikankari Sherwani',
        category: 'Sherwani',
        rentPrice: 8000,
        securityDeposit: 3000,
        status: 'available',
        imageUrl: 'https://images.unsplash.com/photo-1583391733956-3750e0ff4e8b?w=600&q=80',
        description: 'Lucknowi silk chikankari groom sherwani adorned with subtle sequin highlights and cream dhoti-pants.',
        size: '38 (S)',
        chestSize: '38"',
        waistSize: '32"',
        fitType: 'Royal Tailored',
        color: 'Pastel Mint Green',
        includedAccessories: ['Organza Safa', 'Pearl Necklace'],
    },
    {
        id: 'OUT-012',
        name: 'Italian Double-Breasted Wool Blazer',
        category: 'Tuxedo & Suit',
        rentPrice: 5200,
        securityDeposit: 2000,
        status: 'available',
        imageUrl: 'https://images.unsplash.com/photo-1617922001439-4a2e6562f328?w=600&q=80',
        description: 'Classic double-breasted navy blue pinstripe blazer crafted from Italian virgin wool for formal events.',
        size: '42 (L)',
        chestSize: '42"',
        waistSize: '36"',
        fitType: 'Regular Fit',
        color: 'Navy Blue Pinstripe',
        includedAccessories: ['Italian Silk Tie', 'Silk Pocket Square'],
    },
]
